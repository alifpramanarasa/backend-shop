                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @if($invoice->status == 'pending')
                                            <a href="{{ route('admin.order.success', $invoice->id) }}"
                                                class="btn btn-sm btn-success">
                                                <i class="fa fa-check"></i>
                                            </a>
                                            <a href="{{ route('admin.order.failed', $invoice->id) }}"
                                                class="btn btn-sm btn-danger">
                                                <i class="fa fa-times"></i>
                                            </a>
                                        @endif

                                        @if($invoice->status == 'success' && $invoice->tracking_number == null)
                                            <a href="{{ route('admin.order.tracking', $invoice->id) }}"
                                                class="btn btn-sm btn-success">
